        ...
        <tr><!-- Outer Table -->
            <td align="center" data-bgcolor="Body" bgcolor="#F4F4F4" data-composer>
                ...
                <table data-outer-table border="0" align="center" cellpadding="0" cellspacing="0"
                    ...
                    data-module="colibri-preheader-1">
                    <!-- colibri-preheader-1 -->
                    <tr>
                        <td align="center" bgcolor="#fff" data-bgcolor="BgColor">
                            ...
                            <table data-inner-table border="0" align="center" cellpadding="0" cellspacing="0"
                                ...
                                <tr data-element="colibri-preheader-1-logo" data-label="Logo">
                                    <td align="center" class="center-text">
                                        <img style="width:191px;border:0px;display: inline!important;"
                                            src="https://portal.myshariawill.co.uk/assets/images/logoold.png?a=b"
                ...
                <table data-outer-table border="0" align="center" cellpadding="0" cellspacing="0"
                    class="outer-table row" role="presentation" width="640" style="width:640px;max-width:640px;"
                    data-module="colibri-basic-message-1">
                                        ...
                                        <table border="0" cellspacing="0" cellpadding="0" role="presentation"
                                            ...
                                            <tr>
                                                <td align="center" data-border-radius-default="0,6,36"
                                                    ...
                                                    bgcolor="#45517f" style="border-radius: 36px;">
                      
                                                    <singleline>
                                                        <a href="#" mc:edit data-button data-text-style="Buttons"
                                                            style="font-family:'Poppins',Arial,Helvetica,sans-serif;font-size:16px;line-height:20px;font-weight:700;font-style:normal;color:#FFFFFF;text-decoration:none;letter-spacing:0px;padding: 15px 35px 15px 35px;display: inline-block;"><span>GET STARTED</span></a>
                                                    </singleline>
                ...
                <table data-outer-table border="0" align="center" cellpadding="0" cellspacing="0"
                    class="outer-table row" role="presentation" width="640" style="width:640px;max-width:640px;"
                    data-module="colibri-basic-title-1">
                    <!-- colibri-basic-title-1 -->
                    <tr>
                        <td align="center" bgcolor="#fff" data-bgcolor="BgColor">
                            ...
                            <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation"
                                ...
                                <tr data-element="colibri-footer-divider" data-label="Dividers">
                                    <td height="30" style="font-size:30px;line-height:30px;"
                                        data-height="Spacing under divider">&nbsp;</td>
                                </tr>
                                        ...
                                        <table border="0" align="center" cellpadding="0" cellspacing="0"
                                            ...
                                            <tr>
                                                <td class="center-text" data-text-style="Paragraphs" align="center"
                                                    ...
                                                    <multiline>
                                                        <div mc:edit data-text-edit>
                                                        &copy; {{date('Y')}} - My Sharia Will - All Rights Reserved
                                                        </div>
                                                    </multiline>
                                                </td>
                                            </tr>
                                ...
                                <tr data-element="colibri-footer-logo" data-label="Logo on Footer">
                                    <td height="30" style="font-size:30px;line-height:30px;"
                                        data-height="Spacing under logo">&nbsp;</td>
                                </tr>
                                <tr data-element="colibri-footer-logo" data-label="Logo on Footer">
                                    <td align="center" class="center-text">
                                        <img style="width:191px;border:0px;display: inline!important;"

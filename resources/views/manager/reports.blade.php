                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr  UserID="{{ $item['UserID'] }}" class="MainTR">
                                            <td>{{ $item->username }}</td>
                                            ...
                                            <td>
                                                ...
                                                <form action="{{ route('manager_update_approval_status') }}" class="ApproveForm" method="post">
                                                    @csrf
                                                    <input type="hidden" value="approved" name="approval_status">
                                                    <input type="hidden" value="{{ $item->id }}" name="report_history_id">
                                                    <button class="btn btn-sm btn-success mr-1 BtnConfirmApproveReport" type="button">Approve</button>
                                                </form>
                                                <form action="{{ route('manager_update_approval_status') }}" class="RejectForm" method="post">
                                                    @csrf
                                                    <input type="hidden" value="rejected" name="approval_status">
                                                    <input type="hidden" value="{{ $item->id }}" name="report_history_id">
                                                    <input type="hidden" value="" name="rejection_remarks">
                                                    <button class="btn btn-sm btn-danger BtnConfirmRejectReport" type="button">Reject</button>
                                                </form>
                                                </div>
                                            </td>
                                        </tr>
